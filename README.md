O trabalho consiste em desenvolver e implementar uma aplicação web para utilização da camada de modelo criada baseada em site de gerenciamento de condominio.
